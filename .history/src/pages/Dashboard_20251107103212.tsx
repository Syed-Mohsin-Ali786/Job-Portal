        ...
        <div className="inline-block min-h-screen border-r-2 border-gray-400">
          <ul className="flex flex-col items-start pt-5">
            ...
            >
              ...
              <p className="max-sm:h-1">Add Job</p>
            </NavLink>
            <NavLink
              className={({ isActive }) =>
                `flex items-center p-3 sm:px-6 gap-2 w-full hover:bg-gray-100 ${
                  isActive && "bg-blue-100 border-r-3 border-blue-500"
                }`
              }
              to={"/dashboard/manage-job"}
            >
              <img className="min-w-4" src={assets.home_icon} alt="" />
              <p className="max-sm:h-1">Manage Jobs</p>
            </NavLink>
            <NavLink
              className={({ isActive }) =>
                `flex items-center p-3 sm:px-6 gap-2 w-full hover:bg-gray-100 ${
            ...
            >
              ...
              <p className="max-sm:h-1">View Applications</p>
            </NavLink>
          </ul>
        </div>
