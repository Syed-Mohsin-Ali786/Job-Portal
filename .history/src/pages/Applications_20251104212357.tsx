            ...
            {jobsApplied.map((job, index) =>
              true ? (
                <tr>
                  ...
                  <td className="py-2 px-4 border-b"><span className={`${job.status==="Accepted"?"bg-green-100":job.status==="Rejected"?"bg-red-100":"bg-blue-100"} px-4 py-1.5 rounded border`}>{job.status}</span></td>
                </tr>
              ) : null
            )}
          </tbody>
