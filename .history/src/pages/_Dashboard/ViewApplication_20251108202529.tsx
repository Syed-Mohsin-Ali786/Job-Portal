          ...
          <tbody>
            {viewApplicationsPageData.map((applicant, index) => (
              <tr key={index} className="text-gray-700">
                <td className="px-4 py-2 border-b text-center"><span className="w-4 h-auto">{index + 1}</span></td>
                ...
                <td className="px-4 py-2 border-b relative">
                  <div className="relative inline-block text-left group ">
                    ...
                    <div className="z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block">
                      ...
                      <button className="block w-full text-left px-4 py-2 text-red-500 hover:bg-gray-100 ">Decline </button>
                    </div>
                  </div>
                </td>
              </tr>
